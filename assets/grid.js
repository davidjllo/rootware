...
var jquery_trend = __webpack_require__(11);

// EXTERNAL MODULE: ./node_modules/jquery-revealer/jquery.revealer.js
var jquery_revealer = __webpack_require__(12);

// EXTERNAL MODULE: ./source/scripts/polyfills/nodeListForEach.js
var nodeListForEach = __webpack_require__(13);
...
var intersection_observer = __webpack_require__(14);
...
var polyfill_nodelist_foreach = __webpack_require__(15);
...
var TemplateAccount = /*#__PURE__*/function () {
  function TemplateAccount(template) {
    var _this = this;

    _classCallCheck(this, TemplateAccount);

    this.$el = $(template.el);
    $('.delete-address', this.$el).on('click', function (event) {
      return _this.deleteAddress(event);
    });
    $('.edit-address', this.$el).on('click', function (event) {
      return _this.editAddress(event);
    });
    $('.add-new-address', this.$el).on('click', function () {
      return _this.addNewAddress();
    });
    $('.toggle-forgetfulness', this.$el).on('click', function () {
      return _this.recoverPassword();
    });
    $('.address-country', this.$el).on('change', function () {
      return _this.updateProvinceSelectText();
    });

    if (this.$el.hasClass('template-customers-addresses')) {
      this.prepareAddresses();
    }

    if (this.$el.hasClass('template-customers-login')) {
      this.checkForReset();
    }
  ...
  _createClass(TemplateAccount, [{
    ...
    value: function recoverPassword() {
      $('.recover-password', this.$el).toggle();
      $('.customer-login', this.$el).toggle();
    }
  }, {
    key: "checkForReset",
    value: function checkForReset() {
      if ($('.reset-check', this.$el).data('successful-reset') === true) {
        $('.successful-reset', this.$el).show();
      }
    }
  }, {
    ...
    value: function prepareAddresses() {
      ...
      if (addresses.length) {
        return addresses.map(function (index, address) {
          var addressID = $(address).data('address-id');
          return new Shopify.CountryProvinceSelector("address-country-".concat(addressID), "address-province-".concat(addressID), {
    ...
    value: function deleteAddress(e) {
      var addressID = $(e.target).parents('[data-address-id]').data('address-id');
    ...
    value: function editAddress(e) {
      var addressID = $(e.target).parents('[data-address-id]').data('address-id');
      $('.customer-address', this.$el).removeClass('editing').find('.edit-address').removeClass('disabled');
      $(".customer-address[data-address-id='".concat(addressID, "']"), this.$el).addClass('editing').find('.edit-address').addClass('disabled');
      $('.customer-address-edit-form, .customer-new-address', this.$el).addClass('hidden');
      return $(".customer-address-edit-form[data-address-id='".concat(addressID, "']"), this.$el).removeClass('hidden');
    }
  }, {
    key: "addNewAddress",
    value: function addNewAddress() {
      $('.customer-address', this.$el).removeClass('editing').find('.edit-address').removeClass('disabled');
      $('.customer-address-edit-form', this.$el).addClass('hidden');
      return $('.customer-new-address', this.$el).removeClass('hidden');
    }
  }, {
    key: "updateProvinceSelectText",
    value: function updateProvinceSelectText() {
      return $('.address-province', this.$el).siblings('.selected-text').text("-- ".concat(Theme.pleaseSelectText, " --"));
    }
  }]);
...
var TemplateLogin = /*#__PURE__*/function () {
  function TemplateLogin() {
    ...
    $('.admin-login-modal').on('click', function () {
  ...
  TemplateLogin_createClass(TemplateLogin, [{
    ...
    value: function closeModal(e) {
      ...
      if ($(e.target).hasClass('visible')) {
        this.modalWrapper.removeClass('visible').one('trend', function () {
          _this2.$el.removeClass('scroll-locked');
        });
      }
    }
  }, {
    ...
    value: function openModal() {
      ...
      this.positionModal();
      this.modalWrapper.addClass('visible');
    }
  }, {
    key: "positionModal",
...
var RTE_RTE = /*#__PURE__*/function () {
  function RTE(component) {
    ...
    this.$el = $(this.el);
    this.setupTabs();
    reframe_es(this.$el.find('iframe').addBack('iframe'));
  ...
  RTE_createClass(RTE, [{
    ...
    value: function setupTabs() {
      return new dist_default.a(this.$el.get(0), {
        layout: 'tabs',
        intelliparse: false
      });
    }
...
var Select = /*#__PURE__*/function () {
  ...
  Select_createClass(Select, [{
    key: "updateSelectText",
    value: function updateSelectText() {
      var newOption = this.$el.find('option:selected').prop('selected', true).text();
...
var DynamicBlog_DynamicBlog = /*#__PURE__*/function () {
  function DynamicBlog(section) {
    ...
    this.$el = $(this.el);
    this.$window = $(window);
    this.$container = this.$el.find("[".concat(this.container, "]"));
    this.flickity = null;
  ...
  DynamicBlog_createClass(DynamicBlog, [{
    ...
    value: function _bindEvents() {
      return this.$window.on('resize.home-blog-posts', scripts_themeUtils.debounce(this._flickity, 100));
    }
  }, {
    key: "onSectionUnload",
    ...
    value: function _flickity() {
      ...
      this.flickity = new js_default.a(this.$container[0], {
        cellAlign: 'left',
    ...
    value: function _destroyFlickity() {
      if (this.flickity) {
        ...
        this.$container.off('home-blog-posts-height');
        this.$container.off('rimg:load');
      }
    }
  }, {
    key: "_flickityEvents",
    value: function _flickityEvents() {
      ...
      this.$container.on('home-blog-posts-height', function () {
        return scripts_themeUtils.flickityResize(_this.flickity);
      });
      this.$container.on('rimg:load', function () {
        return scripts_themeUtils.flickityResize(_this.flickity);
      }); // Sets the Slider to the height of the first slide

      this.$container.trigger('home-blog-posts-height');
      this.$window.on('resize.home-blog-posts-flickity', scripts_themeUtils.debounce(function () {
        return _this.$container.trigger('home-blog-posts-height');
      }, 10));
    }
  }]);
...
var DynamicCollectionsList_DynamicCollectionsList = /*#__PURE__*/function () {
  function DynamicCollectionsList(section) {
    ...
    this.$collectionsContainer = $('[data-collections]', this.$el);
  ...
  DynamicCollectionsList_createClass(DynamicCollectionsList, [{
    ...
    value: function _bindEvents() {
      ...
      $('.home-collection-overlay-wrapper').on('click', function (event) {
        return _this._redirectCollection;
      });
      this.$el.on('rimg:load', function () {
        _this._setupCollections();
      });
      $(window).on('resize.collections-view', scripts_themeUtils.debounce(this._setupCollections, 500));
    }
  }, {
    key: "_unbindEvents",
    value: function _unbindEvents() {
      $('.home-collection-overlay-wrapper').off('click');
      $(window).off('resize.collections-view');
    }
  }, {
    ...
    value: function _setupCollections() {
      ...
      $.each(featuredCollectionImages, function (index, collectionImage) {
        ...
        if (collectionImageHeight > 0) {
          _this2.collectionHeight = collectionImage.getBoundingClientRect().height;
        }
      });
      $(featuredCollectionImages).css({
        height: ''
      });
      this.$el.find('.home-collection-image').height(this.collectionHeight);
    }
  }, {
    key: "_redirectCollection",
    value: function _redirectCollection(e) {
      var $currentTarget = $(e.currentTarget);
      if (!$currentTarget.parents(this.$collectionsContainer).length) return;
...
// CONCATENATED MODULE: ./source/scripts/helpers/LinkedOptions.js
  ...
  LinkedOptions_createClass(LinkedOptions, [{
    ...
    value: function _getCurrent(optionIndex) {
      ...
      if (this.options.type === 'radio') {
        switch (optionIndex) {
          ...
          case 2:
            var option1 = this.options.$selector.filter('[data-option-index=0]').filter(':checked').val();
            var option2 = this.options.$selector.filter('[data-option-index=1]').filter(':checked').val();
    ...
    value: function _updateOptions(optionIndex, optionsMap) {
      ...
      if (this.options.type === 'select') {
        ...
        $.each($selectorOptions, function (index, option) {
          var $option = $(option);
    ...
    value: function _mapVariants(product) {
      ...
      for (var i = 0; i < product.variants.length; i++) {
        ...
        if (variant.available) {
          ...
          optionsMap.root = scripts_themeUtils.unique(optionsMap.root); // Gather values for the 2nd option type

          if (product.options.length > 1) {
            key = variant.option1;
            optionsMap[key] = optionsMap[key] || [];
            optionsMap[key].push(variant.option2);
            optionsMap[key] = scripts_themeUtils.unique(optionsMap[key]);
      ...
      return this.options.$selector.on('change', function (event) {
        var index = parseInt($(event.currentTarget).attr('data-option-index'), 10);
...
var VariantHelper_VariantHelper = /*#__PURE__*/function () {
  function VariantHelper(options) {
    ...
    var defaultOptions = {
      ...
      // Set with JSON containing product message strings and/or display options,
      unitPrice: null,
      // Set with DOM node containing unit price
      taxLine: null // DOM node containing 'tax included' text

    };
    this.options = scripts_themeUtils.extend(defaultOptions, options);
    this.$body = $(document.body);
    this.linkedOptions = null;
    this.enableHistory = false;
    this.$masterSelect = this.options.$productForm.find('.product-select'); // Disabled history state updating in the TE
  ...
  VariantHelper_createClass(VariantHelper, [{
    ...
    value: function _bindEvents() {
      ...
      return this.options.$selector.on('change.variant-helper', function (event) {
    ...
    value: function _setSelectLabel() {
      ...
      var selectedOption = $target.find('option:selected').val();
    ...
    value: function _getVariantFromOptions(productOptions) {
      ...
      var _loop = function _loop(i) {
        var variant = _this2.options.productJSON.variants[i];
    ...
    value: function _updateMasterSelect(variant) {
      ...
      __guard__(this.$masterSelect.find("[data-variant-id=".concat(variant.id, "]")), function (x) {
        return x.prop('selected', true);
      });
    ...
    value: function _updatePrice(variant) {
      ...
      if (variant) {
        ...
        for (var i = 0; i < $priceFields.length; i++) {
          var priceField = $priceFields[i];
          var $moneyEl = $(priceField).find('.money');

          for (var j = 0; j < $moneyEl[0].attributes.length; j++) {
            var attribute = $moneyEl[0].attributes[j];

            if (attribute.name.indexOf('data-') > -1) {
              $moneyEl.removeAttr(attribute.name);
            }
          }
        }
        ...
        if (taxLine) {
          if (variant.taxable) {
            ...
            productDetails.classList.add('has-tax-line');
          } else {
            taxLine.classList.add('hidden');
            productDetails.classList.remove('has-tax-line');
          }
        }
        ...
        if (variant.compare_at_price > variant.price) {
          $priceFields.find('.money:not(.original)').html(Shopify.formatMoney(variant.price, Theme.moneyFormat));
          $priceFields.find('.original').html(Shopify.formatMoney(variant.compare_at_price, Theme.moneyFormat)).addClass('visible');
        } else {
          $priceFields.find('.money').html(Shopify.formatMoney(variant.price, Theme.moneyFormat));
          $priceFields.find('.original').removeClass('visible');
        }
  ...
  ImageZoom_createClass(ImageZoom, [{
    ...
    value: function _unbindEvents() {
      if (this.zoomAreaContainer) {
        this.zoomAreaContainer.off('click');
      }

      if (this.zoomArea) {
        this.zoomArea.off('mouseout');
        this.zoomArea.off('mousemove');
      }
    }
  }, {
    key: "setVariables",
    value: function setVariables() {
      ...
      this.$el = $(this.images[this.imageId]);
      ...
      this.zoomAreaContainer.on('click', this.toggleZoom.bind(this));
      this.zoomArea.on('mouseout', this.toggleZoom.bind(this));
      this.zoomArea.on('mousemove', this.zoomImage.bind(this));
    }
  }, {
    key: "prepareZoom",
    value: function prepareZoom(resetVariables) {
      ...
      var photoAreaWidth = this.zoomAreaContainer.width();
      var photoAreaHeight = this.zoomAreaContainer.height();
      ...
      $(newImage).on('load', function () {
        ...
        if (ratio < 1.4) {
          _this.zoomAreaContainer.removeClass('zoom-enabled');
        } else {
          _this.zoomAreaContainer.addClass('zoom-enabled');
      ...
      return newImage.src = imageSource;
    }
  }, {
    key: "toggleZoom",
    value: function toggleZoom(e) {
      if (this.zoomAreaContainer.hasClass('zoom-enabled')) {
        if (e.type === 'mouseout') {
    ...
    value: function zoomImage(e) {
      ...
      var bigImageOffset = this.zoomAreaContainer.offset();
...
var ProductSlideshow_ProductSlideshow = /*#__PURE__*/function () {
  function ProductSlideshow(component) {
    var _this = this;

    ProductSlideshow_classCallCheck(this, ProductSlideshow);

    this.el = component.el;
    this.$images = $(component.el);
    this.$images.on('click', '.product-thumbnails-navigation-previous, .product-thumbnails-navigation-next', function (event) {
      return _this.moveProductThumbnails(event);
    });
    this.productThumbnailsWrapper = this.$images.find('.product-gallery--navigation-wrapper');
    this.productThumbnails = this.$images.find('.product-gallery--navigation');
    this.productThumbnail = this.$images.find('.product-gallery--media-thumbnail');
    this.moving = false;

    if (this.productThumbnails.length > 0) {
      dist_index_es.watch(this.productThumbnails.get(0));
    }

    if (this.productThumbnails.hasClass('has-side-scroll')) {
      this.setupProductSlideshow();
      this.productThumbnails.on('rimg:load', function () {
  ...
  ProductSlideshow_createClass(ProductSlideshow, [{
    ...
    value: function setupProductSlideshow(onResize) {
      var tallestImageHeight = 0;
      var containerWidth = 0;
      this.productThumbnailPadding = parseInt(this.productThumbnail.css('padding-left'), 10) * 2;
      this.productThumbnailMargin = parseInt(this.productThumbnail.css('margin-right'), 10) * 2;
      this.productThumbnail.width(this.productThumbnailsWrapper.width() / 4 - this.productThumbnailPadding - this.productThumbnailMargin);

      for (var i = 0; i < this.productThumbnail.length; i++) {
        var image = this.productThumbnail[i];
        var currentImageHeight = image.getBoundingClientRect().height;
        var currentImageWidth = image.getBoundingClientRect().width + this.productThumbnailMargin;

        if (currentImageHeight > tallestImageHeight) {
          tallestImageHeight = currentImageHeight;
        }

        currentImageWidth += this.productThumbnailMargin;
        containerWidth += currentImageWidth;
      }

      this.productThumbnailsWrapper.height(tallestImageHeight);
      this.productThumbnails.width(containerWidth);
    }
  }, {
    key: "moveProductThumbnails",
    value: function moveProductThumbnails(e) {
      var containerWidth = this.productThumbnailsWrapper.width();
      var currentPosition = this.productThumbnails.position().left; // To prevent moving the slider too far to one side or another by clicking next/previous when it's between slides
      ...
      if ($(e.currentTarget).hasClass('product-thumbnails-navigation-next') && currentPosition - containerWidth > -this.productThumbnails.outerWidth()) {
        this.productThumbnails.css({
    ...
    value: function selectThumbnail(mediaId) {
      var thumbnail = this.productThumbnails[0].querySelector("[data-media=\"".concat(mediaId, "\""));
...
var MasonryGrid_MasonryGrid = /*#__PURE__*/function () {
  function MasonryGrid(options) {
    ...
    this.settings = scripts_themeUtils.extend(defaultSettings, options.settings);
    this.masonry = new masonry_default.a(this.$el[0], this.settings);
    this.layout();
    this.$el.on('rimg:load', function () {
      _this.layout();
    });
  ...
  ProductGallery_createClass(ProductGallery, [{
    ...
    value: function _initLayout() {
      ...
      if (this.layout === 'masonry') {
        ...
        this.slideshow = new ProductSlideshow_ProductSlideshow({
          el: this.el
        });
      ...
      if (scripts_themeUtils.isSmall()) {
        ...
        if (!this.productMasonryLayout) {
          if (this.figures.length > 1) {
            this.productMasonryLayout = new MasonryGrid_MasonryGrid({
              $el: $(this.el),
              settings: {
    ...
    value: function _initProductFlickity() {
      ...
      if (!this.flickity) {
        this.flickity = new js_default.a(this.el, {
          cellAlign: 'left',
...
var Product_Product = /*#__PURE__*/function () {
  function Product(el, options) {
    ...
    this.el = el;
    this.$el = $(el); // Set up conditional options

    this.product = options.product;
    this.productSettings = options.product_settings;
    this.labels = JSON.parse($('[data-product-success-labels]').html());
    ...
    this.window.on('resize.product-gallery', function () {
      return _this.reloadGallery;
    });
    $('.rte', this.$el).each(function (index, rte) {
      _this.rteViews.push(new RTE_RTE({
        el: rte
      }));
    });
    $('select', this.$el).each(function (index, select) {
    ...
    this.$addToCart.on('click', function (event) {
    ...
    if (this.imagesLayout === 'list') {
      this.window.on('load.product-images-list, resize.product-images-list', scripts_themeUtils.debounce(this.setupProductDetails, 100));
    }
  }
  ...
  Product_createClass(Product, [{
    ...
    value: function _initProductGallery() {
      this.productGallery = new ProductGallery_ProductGallery(this.el.querySelector('[data-product-gallery]'), {
        product_container: this.$productContainer[0],
    ...
    value: function unload() {
      ...
      this.window.off('.product-images-list');
      this.window.off('.product-gallery');
    }
  }, {
    key: "setupVariants",
    value: function setupVariants() {
      ...
      this.$priceArea = this.$el.find('.product-price'); // Setup product information

      this.$variantDropdowns = this.$el.find('[data-option-select]');
      this.variantHelpers = new VariantHelper_VariantHelper({
    ...
    value: function positionProductInfo() {
      var detailsHeight = this.productDetails.get(0).getBoundingClientRect().height;
    ...
    value: function triggerFixedProductInfo() {
      ...
      var imagesHeight = this.productImages.get(0).getBoundingClientRect().height;
      var imagesOffsetTop = this.productImages.offset().top;
      var imagesOffsetBottom = imagesOffsetTop + imagesHeight;
      var detailsWrapperOffset = this.productDetailsWrapper.offset().top;
      var detailsHeight = this.productDetails.get(0).getBoundingClientRect().height;
      var detailsOffsetTop = this.productDetails.offset().top;
      ...
      if (this.productDetails.get(0).getBoundingClientRect().height < imagesHeight) {
        ...
        if (detailsWrapperOffset - scrollTop < 0) {
          ...
          if (detailsOffsetBottom >= imagesOffsetBottom || scrollTop >= detailsOffsetTop) {
            this.productDetails.removeClass('product-details-fixed').addClass('product-details-absolute');
          }
        } else {
          this.productDetails.removeClass('product-details-fixed').removeClass('product-details-absolute');
        }
    ...
    value: function addToCart(e) {
      ...
      $.post(window.Theme.routes.cart_add_url, this.$productForm.serialize(), null, 'json').done(function (item) {
        ...
        return setTimeout(function () {
          _this2.productMessages.html(message).addClass('success-message').removeClass('error-message');

          return _this2.updateCart(item);
        }, 500);
      }).fail(function (error) {
        return _this2.handleErrors(error);
      });
    }
  }, {
    key: "updateCart",
    value: function updateCart(newItem) {
      $('.mini-cart').removeClass('empty');
      var miniCartItemWrapper = document.querySelector('.mini-cart-item-wrapper');
      var cartCount = $('.cart-count-number');
      var labels = this.labels;
      shopify_asyncview_dist_index_es.load(window.Theme.routes.cart_url, '_mini-ajax').done(function (_ref) {
        var options = _ref.options,
            html = _ref.html;
        var updatedMiniCart = document.createElement('div');
        updatedMiniCart.innerHTML = html.miniCart;
        cartCount.text(options.itemCount);
    ...
    value: function handleErrors(error) {
      ...
      return setTimeout(function () {
        return _this3.$el.find('.product-message').html(error.responseJSON.description).addClass('error-message').removeClass('success-message');
      }, 1000);
    }
  }]);
...
var Quickshop_Quickshop = /*#__PURE__*/function () {
  function Quickshop() {
  ...
  Quickshop_createClass(Quickshop, [{
    ...
    value: function open(url, productSha256) {
      ...
      this.load(url, productSha256).done(function (data) {
        ...
        _this2.product = new Product_Product(_this2.injectEl, data.options);
...
var ProductListItem_ProductListItem = /*#__PURE__*/function () {
  function ProductListItem(component) {
    var _this = this;

    ProductListItem_classCallCheck(this, ProductListItem);

    this.$el = $(component.el);
    $('.product-list-item-thumbnail', this.$el).on('click', function (event) {
    ...
    if (this.productHover === 'quick-shop') {
      ...
      $('.quick-shop-modal-trigger', this.$el).on('click', function (event) {
        return _this.openQuickShop(event);
      });
      $('.quick-shop-modal-trigger', this.$el).on('mouseover', function (event) {
  ...
  ProductListItem_createClass(ProductListItem, [{
    ...
    value: function remove() {
      if (this.quickshop) {
        ...
        $('.quick-shop-modal-trigger', this.$el).off('click');
        $('.quick-shop-modal-trigger', this.$el).off('mouseover');
      }

      $('.product-list-item-thumbnail', this.$el).off('click');
    }
  }, {
    key: "redirectToProduct",
    value: function redirectToProduct(e) {
      var $target = $(e.target);
      var url = !$target.hasClass('quick-shop-modal-trigger') ? $target.data('url') : null;
      var isSlider = $target.closest('.flickity-slider').length;
...
var DynamicFeaturedCollection_DynamicFeaturedCollection = /*#__PURE__*/function () {
  function DynamicFeaturedCollection(section) {
    ...
    this.$window = $(window);
    this.productViews = [];
    this.$container = this.$el.find('[data-products-container]');
  ...
  DynamicFeaturedCollection_createClass(DynamicFeaturedCollection, [{
    ...
    key: "_bindEvents",
    value: function _bindEvents() {
      this.$window.on('resize.home-featured-collections', scripts_themeUtils.debounce(this._flickity, 100));
    }
  }, {
    key: "_setupProducts",
    value: function _setupProducts() {
      ...
      $('.product-list-item', this.$el).each(function (index, productItem) {
        _this.productViews.push(new ProductListItem_ProductListItem({
          el: productItem
        }));
      });
    }
    ...
    value: function _destroyFlickity() {
      if (this.flickity) {
        ...
        this.$container.off('home-featured-collections-height');
        this.$container.off('rimg:load');
      }
    }
  }, {
    ...
    value: function _flickityEvents() {
      ...
      // Check for tallest slide at start of transition
      this.flickity.on('cellSelect', function () {
        _this2.$container.trigger('home-featured-collections-height');
      }); // Check for tallest slide at end of transition
      ...
      if (this.flickity) {
        this.$container.on('rimg:load', function () {
          scripts_themeUtils.flickityResize(_this2.flickity);
        });
      }

      this.$container.on('home-featured-collections-height', function () {
        scripts_themeUtils.flickityResize(_this2.flickity);
      }); // Sets the Slider to the height of the first slide

      this.$container.trigger('home-featured-collections-height');
      this.$window.on('resize.home-featured-collections-flickity', scripts_themeUtils.debounce(function () {
        return _this2.$container.trigger('home-featured-collections-height');
      }, 10));
    }
  }]);
...
var Modal_Modal = /*#__PURE__*/function () {
  function Modal() {
    ...
    this.callbacks = $.extend({}, defaultCallbacks, component.callbacks);
  ...
  Modal_createClass(Modal, [{
    ...
    value: function open() {
      ...
      this.$window.on('resize.modal', function () {
    ...
    value: function showModal() {
      ...
      return this.$el.addClass(this.selectors.visible).one('trend', function () {
        return _this3.$el.addClass(_this3.selectors.active);
      });
    }
  }, {
    key: "_resize",
    value: function _resize() {
      this._position(); // Some modals shouldn't be visible on mobile
...
var MasonryVideo_MasonryVideo = /*#__PURE__*/function () {
  function MasonryVideo($el, event) {
    ...
    var modalID = $target.attr('data-masonry-video');
    var $modal = this.$el.find("[data-modal-id=".concat(modalID, "]"));
    this.modal = new Modal_Modal({
      el: $modal,
      callbacks: {
        onOpen: function onOpen($els) {
  ...
  MasonryVideo_createClass(MasonryVideo, [{
    ...
    key: "_open",
    value: function _open($els) {
      var $videoContents;
      var $modal = $els.$modal,
          $contents = $els.$contents;
      var $videoJson = $modal.find('[data-masonry-video]');
      ...
      var $vid = $contents.html($videoContents);
      reframe_es($vid.find('iframe').addBack('iframe'));
...
var DynamicMasonry_DynamicMasonry = /*#__PURE__*/function () {
  function DynamicMasonry(section) {
    ...
    this.urls = $('[data-masonry-url]', this.$el);
    this.videos = $('[data-masonry-video]', this.$el);
  ...
  DynamicMasonry_createClass(DynamicMasonry, [{
    ...
    value: function _bindEvents() {
      ...
      this.urls.on('click', function (event) {
    ...
    value: function onSectionUnload() {
      ...
      this.urls.off('click');
      this.videos.off('click');
    }
  }, {
    key: "_redirectMasonryFeatures",
    value: function _redirectMasonryFeatures(e) {
      var $target = $(e.currentTarget);
      if (!$target.parents(this.$masonry).length) return;
      var url = $target.data('masonry-url');
    ...
    value: function _masonryVideo(event) {
      this.masonryVideo = new MasonryVideo_MasonryVideo(this.$el, event);
    }
  }]);
...
var DynamicPromotion_DynamicPromotion = /*#__PURE__*/function () {
  function DynamicPromotion(section) {
    ...
    this.$wrapper = $('[data-promotion-wrapper]', this.$el);
    this.$content = $('[data-promotion-content]', this.$el);
    this.$image = $('[data-promotion-image]', this.$el);
  ...
  DynamicPromotion_createClass(DynamicPromotion, [{
    key: "remove",
    value: function remove() {
      this.$window.off('.home-promotion');
    }
  }, {
    key: "onSectionUnload",
    value: function onSectionUnload() {
    ...
    key: "_bindEvents",
    value: function _bindEvents() {
      this.$window.on('resize.home-promotion', scripts_themeUtils.debounce(this.adjustHeight, 100));
      return this.$window.on('scroll.home-promotion', scripts_themeUtils.debounce(this.adjustHeight, 10));
    ...
    value: function _headerOffset() {
      ...
      var headerScrolledHeight = this.$header.find('.navigation').outerHeight(true);
      var isFirstChild = this.$parent.is(':first-child');
      var isStickyEnabled = this.$body.hasClass('sticky-header');
      ...
      if (isFirstChild) {
        ...
        this.$wrapper.height(newHeight); // Otherwise, if its larger than tablet, and sticky is enabled, take off nav height
      }

      if (!scripts_themeUtils.isMedium() && isStickyEnabled) {
        newHeight = maxHeight - headerScrolledHeight;
        this.$wrapper.height(newHeight); // Is not tablet, and header is not sticky, remove offset
      }
...
var DynamicSlideshow_DynamicSlideshow = /*#__PURE__*/function () {
  ...
  DynamicSlideshow_createClass(DynamicSlideshow, [{
    ...
    value: function onSectionBlockSelect(block) {
      ...
      var slideIndex = parseInt($(block.el).data('slide-index'), 10);
...
var DynamicTestimonials_DynamicTestimonials = /*#__PURE__*/function () {
  function DynamicTestimonials(section) {
    ...
    this.$window = $(window);
    this.$testimonialsContainer = this.$el.find("[".concat(this.container, "]"));
    this.flickity = null;
  ...
  DynamicTestimonials_createClass(DynamicTestimonials, [{
    ...
    key: "_bindEvents",
    value: function _bindEvents() {
      this.$window.on('resize.testimonials', scripts_themeUtils.debounce(this._flickity, 100));
    }
  }, {
    key: "_flickity",
    value: function _flickity() {
      ...
      this.flickity = new js_default.a(this.$testimonialsContainer[0], {
        cellAlign: 'center',
    ...
    value: function onBlockSelect(event) {
      ...
      var index = parseInt($(event.target).attr(this.slide), 10) - 1;
...
var DynamicVideoWithTextOverlay = /*#__PURE__*/function () {
  function DynamicVideoWithTextOverlay(section) {
    ...
    this.el = section.el;
    this.$el = $(this.el);
    $('[data-play-video]', this.$el).on('click', function () {
  ...
  DynamicVideoWithTextOverlay_createClass(DynamicVideoWithTextOverlay, [{
    ...
    value: function playVideo() {
      var $overlay = this.$el.find('[data-video-overlay]');
    ...
    key: "remove",
    value: function remove() {
      $('[data-play-video]', this.$el).off('click');
...
var StaticArticle = /*#__PURE__*/function () {
  ...
  StaticArticle_createClass(StaticArticle, [{
    ...
    key: "onSectionUnload",
    value: function onSectionUnload() {
      $(window).off('resize.article-view');
    }
  }, {
    key: "_validate",
    value: function _validate() {
      ...
      $(window).on('resize.article-view', function () {
    ...
    value: function setupFeaturedImage(setup) {
      var $posts = this.$el.find('.blog-post');
      $posts.each(function (index, post) {
        var image = $(post).find('img.highlight').first();

        if (image.length) {
          image.on('rimg:load', function () {
            $(post).find('.blog-post-inner').css({
    ...
    value: function setupFullWidthImages() {
      var postContent = this.$el.find('.post-content');
      var postContentWidth = postContent.outerWidth(true);
      var postContentMargin = postContent.css('marginLeft');
      var result = [];
      $('img.full-width', this.$el).each(function (index, image) {
        image = $(image);
        result.push(image.css({
          width: postContentWidth,
          left: "-".concat(postContentMargin)
        }));
      });
      return result;
    }
    ...
    value: function positionSidebar(position) {
      var sidebar = this.$el.find('.blog-sidebar');

      if (position === 'below') {
        sidebar.insertAfter('.blog-post-wrapper');
      } else {
...
var StaticNavigation_StaticNavigation = /*#__PURE__*/function () {
  function StaticNavigation(section) {
    StaticNavigation_classCallCheck(this, StaticNavigation);

    this.el = section.el;
    this.events = new EventHandler_default.a();
    this.$navigationWrapper = $('[data-navigation-wrapper]', this.el);
  ...
  StaticNavigation_createClass(StaticNavigation, [{
    ...
    value: function reloadNavigation() {
      ...
      if (!scripts_themeUtils.isSmall()) {
        ...
        this.$navigationContent.find('li[data-mega-nav="true"]').removeClass('has-dropdown').addClass('has-mega-nav');
      } else {
        ...
        this.$navigationContent.find('li[data-mega-nav="true"]').removeClass('has-mega-nav').addClass('has-dropdown');
      }
      ...
      this.el.querySelectorAll('.has-dropdown, .has-mega-nav').forEach(function (toggle) {
        return _this.events.register(toggle, 'mouseenter', function (event) {
          if (scripts_themeUtils.isSmall()) return;
          ...
          if (currentTarget.classList.contains('has-mega-nav')) {
            _this._swapMegaNavImages($('.mega-nav-image img', currentTarget));
          }
      ...
      this.el.querySelectorAll('.navigation-submenu').forEach(function (toggle) {
        return _this.events.register(toggle, 'revealer-animating', function (event) {
          ...
          var navigationWidth = _this.$navigationWrapper.width();
    ...
    value: function _onMegaNavAnchorMouseleave(e) {
      var megaNavImage = $(e.target).closest('.mega-nav').children('.mega-nav-image img');
      megaNavImage.attr('src', megaNavImage.data('image')).attr('alt', megaNavImage.data('alt'));
    }
  }, {
    ...
    value: function _openDropdown(triggerEl) {
      ...
      var $dropdown = $(triggerEl).children('.navigation-submenu, .mega-nav');
      var $navigationSubmenuToggle = $(triggerEl).find('.navigation-submenu-toggle');

      if (scripts_themeUtils.isSmall()) {
        triggerEl.classList.add('has-mobile-dropdown--active');
        $dropdown.addClass('navigation-submenu-visible');
    ...
    value: function _closeDropdown(triggerEl) {
      ...
      $dropdown.removeClass('navigation-submenu-visible');
    ...
    value: function _toggleMobileNavigation() {
      ...
      if (this.$body.hasClass('mobile-nav-open') && force !== 'open') {
        this.$navigationContent.removeAttr('style');
        this.$body.removeClass('mobile-nav-open lock-scroll');
        this.$navigationContent.removeClass('visible');
        this.$navigationWrapper.removeClass('visible background'); // Close opened menus on navigation close

        this.$navigationContent[0].querySelectorAll('.has-dropdown--active').forEach(function (triggerEl) {
          return _this3._closeDropdown(triggerEl);
        });
      } else if (!this.$body.hasClass('mobile-nav-open') && force !== 'close') {
    ...
    value: function _swapMegaNavImages(target) {
      ...
      var imageAlt = $(target).data('image-alt');

      if (image && image !== '') {
        $(target).closest('.mega-nav').find('.mega-nav-image img').attr('src', image).attr('srcset', '').attr('alt', imageAlt);
      }
    }
  }]);
...
var StaticHeader_StaticHeader = /*#__PURE__*/function (_StaticNavigation) {
  ...
  function StaticHeader(section) {
    ...
    _this.$header = _this.$el.find('[data-section-type="header"]');
    _this.$mainHeader = _this.$el.find('[data-header-main]');
    _this.$headerContent = _this.$el.find('[data-header-content]');
    _this.$navigationWrapper = _this.$el.find('[data-navigation-wrapper]');
    _this.$navigationContent = _this.$el.find('[data-navigation-content]');
    _this.$branding = _this.$el.find('[data-header-branding]');
    _this.$headerTools = _this.$el.find('.header-tools');
    _this.$headerRight = _this.$el.find('[data-header-content-right]');
    _this.$headerSearch = _this.$el.find('[data-header-search]');
    _this.$headerSearchSubmit = _this.$el.find('[data-header-search-button]');
    _this.$headerSearchClose = _this.$el.find('[data-header-search-button-close]');
  ...
  StaticHeader_createClass(StaticHeader, [{
    ...
    value: function _bindEvents() {
      ...
      this.$window.on('resize.header', function () {
        ...
        _this2.navHeight = _this2.$navigationWrapper.height();
      ...
      this.$headerSearchSubmit.on('click.header-search', function (event) {
        var $target = $(event.currentTarget);
      ...
      this.$headerSearchClose.on('click.header-search', function (event) {
        event.preventDefault();
    ...
    value: function _bindCloseSearch() {
      ...
      this.$body.on('click.header-search-close', event, function () {
        var $parent = $(event.target).parents('[data-header-search]');
    ...
    value: function _shouldHeaderStick() {
      ...
      if (this.isCacheStale) {
        var height = this.$body.hasClass('sticky-header') ? 0 : this.$headerContent.outerHeight(true);
        var stickyHeight = this.$body.hasClass('sticky-header') ? this.$headerContent.outerHeight(true) : 0;
      ...
      if (scripts_themeUtils.isLessThanLarge() || this.$body.hasClass('alternate-index-layout')) {
        shouldStick = false;
      }
    ...
    value: function _toggleSearchForm(open) {
      ...
      var headerSearchWidth = parseInt(this.$headerSearch.data('width'), 10);
      var searchButtonWidth = this.$headerSearchClose.outerWidth(true);
      ...
      this.$mainHeader.toggleClass('header-logo-covered', logoCollision).one('trend', function () {
        if (!open) {
          _this4.$mainHeader.removeClass('header-search-expanded-closing');
        }
      });
      this.$headerRight.css({
        width: headerRightWidth
      });
      this.$headerSearch.css({
    ...
    value: function _setCompactCenterHeights(toggleOn) {
      ...
      var navHeight = this.$navigationContent.outerHeight(true);
      var navOffset = 0;
    ...
    value: function _setupBranding() {
      ...
      var $mobileBranding = this.$branding.clone();
      $mobileBranding.removeAttr('data-header-branding').removeClass('header-branding-desktop').addClass('header-branding-mobile');
      this.$navigationContent.prepend($mobileBranding);
    }
  }, {
    key: "_setSearchWidth",
    value: function _setSearchWidth() {
      var searchWidth = this.$mainHeader.find('.mini-cart-wrapper').outerWidth(true) + this.$mainHeader.find('.checkout-link').outerWidth(true);
  ...
  return StaticHeader;
}(StaticNavigation_StaticNavigation);
...
var StaticCollection_StaticCollection = /*#__PURE__*/function () {
  function StaticCollection(section) {
    ...
    this.el = section.el;
    this.$el = $(this.el);
    $('[data-collection-tags]').on('change', function (event) {
      return _this.filterCollection(event);
    });
    $('[data-collection-sorting]').on('change', function (event) {
      return _this.sortCollection(event);
    });
    this.$masonry = this.$el.find('[data-masonry-grid]');
    this.masonryGrid = null;
    this.productItems = $('.product-list-item');
    this.productListItems = this.productItems.map(function (index, product) {
      return new ProductListItem_ProductListItem({
        el: product
      });
    });
    this.$collectionTags = this.$el.find('[data-collection-tags]');
    this.$collectionSorting = this.$el.find('[data-collection-sorting]');
    ...
    if (this.$masonry.length) {
      this.masonryGrid = new MasonryGrid_MasonryGrid({
        $el: this.$masonry,
        settings: {
  ...
  StaticCollection_createClass(StaticCollection, [{
    ...
    value: function remove() {
      ...
      $('[data-collection-tags]').off('change');
      $('[data-collection-sorting]').off('change');
    }
  }, {
    ...
    value: function sortCollection(event) {
      ...
      if ($target.closest('.select-wrapper').hasClass('vendor-collection')) {
        ...
        return location.search = "".concat(search, "&").concat(jQuery.param(Sorting));
      }
...
var StaticCart_StaticCart = /*#__PURE__*/function () {
  function StaticCart(section) {
    ...
    $('.cart-instructions textarea').on('change', function () {
    ...
    if (hasShippingCalculator) {
      ...
      this.updateSelects = function () {
        for (var i = 0; i < _this.shippingSelects.length; i++) {
          var selectableOption = _this.shippingSelects[i];
          var selectedIndex = selectableOption.selectedIndex,
              options = selectableOption.options;
          var value = options[selectedIndex].value;
          var selectedOption = selectableOption.parentElement.firstElementChild;
          selectedOption.innerHTML = value;
        }
      };

      Shopify.Cart.ShippingCalculator.show({
        submitButton: window.Theme.shippingButton,
        submitButtonDisabled: window.Theme.shippingDisabled,
        customerIsLoggedIn: window.Theme.customerLoggedIn,
        moneyFormat: window.Theme.moneyFormat
      }); // Wait until DOM load, because jquery.cart.min.js does the same and we rely on that

      $(function () {
        for (var i = 0; i < _this.shippingSelects.length; i++) {
          var selectableOption = _this.shippingSelects[i];
          selectableOption.addEventListener('change', _this.updateSelects);
        }

        _this.updateSelects();

        _this.shippingSubmit.addEventListener('click', _this.calculateShipping);

        if (window.Theme.customerAddress) {
          _this._calculateShipping(window.Theme.customerAddress);
        }
      });
    }
  }
  ...
  StaticCart_createClass(StaticCart, [{
    ...
    value: function _bindCartItemEvents() {
      ...
      this.cartDiscountContainer = this.el.querySelector('[data-cart-discount-container]');
      this.totalPrice = this.el.querySelector('[data-total-price]');
      this.$quantityInputs.each(function (i, el) {
        $(el).on('input', function (event) {
          return _this2._updateItemQuantity(event);
        });
      });
      this.$removeItem.each(function (i, el) {
    ...
    value: function onSectionUnload() {
      ...
      for (var i = 0; i < this.shippingSelects.length; i++) {
        this.shippingSelects[i].removeEventListener('change', this.updateSelects);
      }

      $('.cart-instructions textarea').off('change');
    }
  }, {
    ...
    value: function _updateItemQuantity(event) {
      ...
      if (event.currentTarget.hasAttribute('data-remove-item')) {
        ...
        lineItemKey = $quantityInput.data('quantity-key');
      ...
      this.updateTimeout = setTimeout(function () {
        ...
        var thisTimeoutId = _this3.updateTimeout;
        $.ajax({
          type: 'POST',
          ...
          success: function success(cart) {
            ...
            if (_this3.updateTimeout && _this3.updateTimeout !== thisTimeoutId) {
              return;
            }
            ...
            _this3.updateCart(cart, thisTimeoutId);
          }
        });
      }, 300);
    }
    ...
    value: function updateCart(cart, timeoutId) {
      ...
      $('.cart-count-number').text(cart.item_count); // Swap the cart contents to update discount labels.

      shopify_asyncview_dist_index_es.load(window.Theme.routes.cart_url, 'ajax').done(function (_ref) {
        var options = _ref.options,
            html = _ref.html;

        // If another request is in progress, discard this update
        if (_this4.updateTimeout !== timeoutId) {
          return;
        }

        _this4._unbindCartItemEvents(); // Inject new cart table contents


        var newTableContainer = document.createElement('div');
        newTableContainer.innerHTML = html.table;
        morphdom_esm(_this4.cartTable, newTableContainer.querySelector('table'), {
          onBeforeElUpdated: function onBeforeElUpdated(fromEl, toEl) {
        ...
        dist_index_es.watch(_this4.cartTable); // Inject new cart level discounts

        var newDiscountContainer = document.createElement('div');
        newDiscountContainer.innerHTML = html.discounts;
        _this4.cartDiscountContainer.innerHTML = newDiscountContainer.querySelector('[data-cart-discount-container]').innerHTML; // Update total

        _this4.totalPrice.innerHTML = options.totalPrice;

        _this4._bindCartItemEvents(_this4.$el);
      }).fail(function () {
    ...
    value: function saveSpecialInstructions() {
      var newNote = $('.cart-instructions textarea').val();
      return Shopify.updateCartNote(newNote, function (cart) {// empty function so that Shopify's callback isn't invoked
      });
    }
  }, {
    ...
    value: function _calculateShipping(customerAddress) {
      ...
      $.ajax("/cart/shipping_rates.json?".concat(queryString), {
        dataType: 'json'
      }).fail(function (error) {
        return _this5._handleErrors(error.responseJSON || {});
        ...
        $('.cart-shipping-calculator-response', _this5.el).empty().append("<p class='shipping-calculator-response message'></p><ul class='shipping-rates'/></ul>");
        var ratesFeedback = $('.shipping-calculator-response', _this5.el);
        ...
        var $cartShippingRates = $('.shipping-rates', _this5.el);
    ...
    value: function _handleErrors(errors) {
      ...
      if ('zip' in errors) {
        errorMessage = window.Theme.shippingCalcErrorMessage.replace('--error_message--', errorMessage.zip);
      } else {
        errorMessage = errors;
      }

      $('.cart-shipping-calculator-response').html("<p>".concat(errorMessage, "</p>"));
    }
  }]);
...
var StaticBlog_StaticBlog = /*#__PURE__*/function () {
  ...
  StaticBlog_createClass(StaticBlog, [{
    ...
    value: function _validate() {
      ...
      this.setupFeaturedImage();
      this.setupFullWidthImages();
      $(window).on('resize.blog-view', function () {
        _this.setupFullWidthImages();
      ...
      if ($('.blog-tag-filter select', this.$el).length) {
        new Select({
          el: $('.blog-tag-filter select', this.$el)
        });
        $('.blog-tag-filter select').on('change', function (event) {
    ...
    value: function filterBlog(e) {
      if (!this.$el.find('[data-tag-filter]').length) {
        return;
      }
    ...
    value: function setupFeaturedImage(setup) {
      var result = [];
      $('.blog-post', this.$el).each(function (index, post) {
        post = $(post);
        var image = post.find('img.highlight').first();
    ...
    key: "setupFullWidthImages",
    value: function setupFullWidthImages() {
      var postContent = $('.post-content', this.$el);
      var postContentWidth = postContent.outerWidth(true);
      var postContentMargin = postContent.css('marginLeft');
      var result = [];
      $('img.full-width').each(function (index, image) {
        image = $(image);
        image.css({
          width: postContentWidth,
          left: "-".concat(postContentMargin)
    ...
    key: "positionSidebar",
    value: function positionSidebar(position) {
      var sidebar = $('.blog-sidebar', this.$el);

      if (position === 'below') {
        sidebar.insertAfter('.blog-posts');
      } else {
        sidebar.insertBefore('.blog-posts');
      }
    }
  }]);
...
var StaticBlogMasonry_StaticBlogMasonry = /*#__PURE__*/function () {
  function StaticBlogMasonry(section) {
...
var StaticCollectionsList_StaticCollectionsList = /*#__PURE__*/function () {
...
var ProductMasonry_ProductMasonry = /*#__PURE__*/function () {
  function ProductMasonry(component) {
  ...
  ProductMasonry_createClass(ProductMasonry, [{
    ...
    value: function remove() {
      ...
      this.$el.off('rimg:load.product-masonry-layout');
    ...
    value: function _bindEvents() {
      ...
      this.$window.on('resize.product-masonry-layout', scripts_themeUtils.debounce(this._initLayout, 100));
      this.$el.on('rimg:load.product-masonry-layout', function () {
    ...
    value: function _initFlickity() {
      if (this.hasGallery && !this.flickity.gallery) {
        ...
        this.flickity.gallery = new js_default.a(this.$gallery[0], {
          cellAlign: 'left',
      ...
      if (this.hasRelatedProducts && !this.flickity.relatedProducts) {
        ...
        this.flickity.relatedProducts = new js_default.a(this.$relatedProducts[0], {
          cellAlign: 'left',
    ...
    value: function _initMasonry() {
      if (this.hasGallery && !this.masonry.gallery) {
        ...
        this.masonry.gallery = new MasonryGrid_MasonryGrid({
          $el: this.$gallery,
          settings: {
      ...
      if (this.hasRelatedProducts && !this.masonry.relatedProducts) {
        ...
        this.masonry.relatedProducts = new MasonryGrid_MasonryGrid({
          $el: this.$relatedProducts,
          settings: {
    ...
    value: function _galleryReset() {
      this.$gallery.find(this.selectors.gallery.itemSelector).attr('style', '');
    }
  }, {
    key: "_relatedProductsReset",
    value: function _relatedProductsReset() {
      this.$relatedProducts.find(this.selectors.relatedProducts.itemSelector).attr('style', '');
    }
  }, {
    key: "_flickityEvents",
    value: function _flickityEvents(options) {
      var $el = options.$el,
          flickity = options.flickity;
      ...
      this.$window.on('resize.product-images-flickity', scripts_themeUtils.debounce(function () {
        return $el.trigger('product-masonry-layout');
      }, 10));
    }
  }]);
  ...
  StaticProductRecommendations_createClass(StaticProductRecommendations, [{
    ...
    value: function _loadRecommendations() {
      ...
      shopify_asyncview_dist_index_es.load(this.recommendUrl).done(function (_ref) {
        ...
        if (_this.use_masonry) {
          _this.productMasonry = new ProductMasonry_ProductMasonry({
...
var ProductSection_ProductSection = /*#__PURE__*/function () {
  function ProductSection(section) {
    ProductSection_classCallCheck(this, ProductSection);

    this.product = new Product_Product(section.el, section.data);
  }
...
var grid_ThemeView = /*#__PURE__*/function () {
  function ThemeView() {
    var _this = this;

    grid_classCallCheck(this, ThemeView);
    ...
    sections.register('dynamic-collections-list', function (section) {
      return new DynamicCollectionsList_DynamicCollectionsList(section);
    });
    ...
    sections.register('dynamic-masonry', function (section) {
      return new DynamicMasonry_DynamicMasonry(section);
    });
    sections.register('dynamic-promotion', function (section) {
      return new DynamicPromotion_DynamicPromotion(section);
    });
    ...
    sections.register('product', function (section) {
      return new ProductSection_ProductSection(section);
    });
    ...
    sections.register('static-collections-list', function (section) {
      return new StaticCollectionsList_StaticCollectionsList(section);
    });
    ...
    sections.register('static-blog-masonry', function (section) {
      return new StaticBlogMasonry_StaticBlogMasonry(section);
    });
    ...
    var body = $(document.body); // Set up conditionals
  ...
  grid_createClass(ThemeView, [{
    key: "inputPlaceholderFix",
    value: function inputPlaceholderFix() {
      var _this2 = this;

      var placeholders = $('[placeholder]');
      $.each(placeholders, function (index, input) {
        input = $(input);
...
dist_index_es.init();
window.theme = new grid_ThemeView();

/***/ })
/******/ ]);
//# sourceMappingURL=grid.js.map?1595346916654